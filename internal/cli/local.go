...
// reported and does not decide: a build with no stage bodies can start a run,
// and what that run does is hold at its first stage, which is worth knowing
// and is not the same as being unable to start.
