...
// package adds is the envelope: which records answer which call, and the four
// things a driving agent needs that no record holds - the outcome, whether
// anything is advancing the run, the next action, and whether to stop driving.
//
